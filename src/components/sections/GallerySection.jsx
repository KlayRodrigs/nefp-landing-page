...
export function GallerySection() {
  ...
  return (
    isUndefinedNullOrEmpty(gallery) ? null : (
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 mb-10">
            {CATEGORIES.map((cat) => (
              <button
                ...
                className={`px-4 py-1.5 rounded-xl text-xs sm:text-sm font-medium transition-all duration-200 cursor-pointer ${selectedCat === cat
